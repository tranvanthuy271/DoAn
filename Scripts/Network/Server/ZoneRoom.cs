...
public class ZoneRoom
{
    ...
    // Unique key — dùng giống roomId LangLa: "map1_zone0"
    ...
    // Thêm player vào zone. Gọi khi player spawn hoặc transfer đến.
    ...
    public override string ToString() =>
        $"ZoneRoom({ZoneKey}, scene={SceneName}, players={PlayerCount}/{MaxPlayers})";
}
