...
public class PeriodicSyncService : NetworkBehaviour
{
    ...
    /// </summary>
    private void SavePlayerCheckpoint(int playerId, int mapId, float posX, float posY, int hp, int level,
        System.Action onSuccess = null, System.Action<string> onError = null)
    {
        ...
        // Save position (quan trọng nhất)
        APIClient.Instance.UpdatePlayerPosition(
            playerId, 
            mapId, 
            posX, 
            posY,
        ...
        // Có thể thêm save HP, level nếu cần
        // (thông qua PlayerDataSaveService hoặc API endpoint khác)
    }
