...
- Tạo bảng `quest_config` mới với 3 quest mẫu:
  - Quest 1: Diệt 5 Goblin (NPC Đại Tướng Lan, bản đồ 0)
  - Quest 2: Nói chuyện NPC + diệt 10 Goblin (NPC Đại Tướng Lan, kéo sang bản đồ 1)
  - Quest 3: Thu thập 3 mảnh Goblin (NPC Hướng Dẫn Viên, bản đồ 1)
...
- [ ] SQL migration chạy xong (3 quest mẫu có trong DB)
