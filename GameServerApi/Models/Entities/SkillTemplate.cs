...
namespace GameServerApi.Models
{
    ...
    public class SkillTemplate
    {
        ...
        // NULL = Universal; "Fire" | "Water" | "Earth" | "Wood" | "Metal"
        public string? ElementType  { get; set; }
        public int    MaxLevel      { get; set; } = 5;
        // Player level required to learn the skill (unlock level 1)
        public int    LevelToUnlock { get; set; } = 1;
        // Gene tier required to unlock this skill (0 = no gene requirement)
        ...
        // JSON array [{level_req, sp_cost, effect_value, mp_cost, desc}]
